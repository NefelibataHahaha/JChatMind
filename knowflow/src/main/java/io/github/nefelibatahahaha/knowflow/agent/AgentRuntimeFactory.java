package io.github.nefelibatahahaha.knowflow.agent;

import com.fasterxml.jackson.core.JsonProcessingException;
import io.github.nefelibatahahaha.knowflow.agent.tools.Tool;
import io.github.nefelibatahahaha.knowflow.config.ChatClientRegistry;
import io.github.nefelibatahahaha.knowflow.converter.AgentConverter;
import io.github.nefelibatahahaha.knowflow.converter.ChatMessageConverter;
import io.github.nefelibatahahaha.knowflow.converter.KnowledgeBaseConverter;
import io.github.nefelibatahahaha.knowflow.mapper.AgentMapper;
import io.github.nefelibatahahaha.knowflow.mapper.KnowledgeBaseMapper;
import io.github.nefelibatahahaha.knowflow.model.dto.AgentDTO;
import io.github.nefelibatahahaha.knowflow.model.dto.ChatMessageDTO;
import io.github.nefelibatahahaha.knowflow.model.dto.KnowledgeBaseDTO;
import io.github.nefelibatahahaha.knowflow.model.entity.Agent;
import io.github.nefelibatahahaha.knowflow.model.entity.KnowledgeBase;
import io.github.nefelibatahahaha.knowflow.service.ChatMessageFacadeService;
import io.github.nefelibatahahaha.knowflow.service.SseService;
import io.github.nefelibatahahaha.knowflow.service.ToolFacadeService;
...
public class AgentRuntimeFactory {
    ...
    private AgentRuntime buildAgentRuntime(
            Agent agent,
            List<Message> memory,
     ...
     */
    public AgentRuntime create(String agentId, String chatSessionId) {
        Agent agent = loadAgent(agentId);
        //仅属于本次agent创建任务的配置，不保存到factory字段中
        AgentDTO runtimeConfig = toAgentConfig(agent);
        // AgentRuntime 内部允许 maxMessages 为 null，并会使用默认值 20
