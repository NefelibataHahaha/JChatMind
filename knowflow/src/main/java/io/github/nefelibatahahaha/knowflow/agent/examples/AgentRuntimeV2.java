...
import io.github.nefelibatahahaha.knowflow.agent.AgentState;
 ...
 */
@Slf4j
public class AgentRuntimeV2 extends AgentRuntimeV1 {
    ...
    public AgentRuntimeV2() {
        super();
    }
    
    public AgentRuntimeV2(String name,
                      String description,
                      String systemPrompt,
