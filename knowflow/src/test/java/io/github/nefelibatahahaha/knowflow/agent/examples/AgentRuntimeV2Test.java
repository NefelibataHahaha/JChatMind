package io.github.nefelibatahahaha.knowflow.agent.examples;

import io.github.nefelibatahahaha.knowflow.agent.tools.test.CityTool;
import io.github.nefelibatahahaha.knowflow.agent.tools.test.DateTool;
import io.github.nefelibatahahaha.knowflow.agent.tools.test.WeatherTool;
 ...
 */
@SpringBootTest
public class AgentRuntimeV2Test {
    ...
    public void testToolCalling() {
        ...
        // 创建 V2 实例
        AgentRuntimeV2 agent = new AgentRuntimeV2(
                "test-agent-v2",
                "测试 Agent V2",
